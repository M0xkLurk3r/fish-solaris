...
CXXFLAGS = -g -O2 -D_LARGEFILE_SOURCE=1 -D_FILE_OFFSET_BITS=64 -fno-exceptions -Wall -Wno-sign-compare  -I$(PCRE2_DIR)/src -iquote. -iquote./src/ $(MACROS) $(EXTRA_CXXFLAGS)
CPPFLAGS = 
LDFLAGS = 
LIBS = -lncurses -lsocket  -L$(PCRE2_LIBDIR) -lpcre2-$(PCRE2_WIDTH)
