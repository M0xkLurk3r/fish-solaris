...
#define std::wcsdup(a) wcsdup_use_weak((a))
#define std::wcscasecmp(a, b) wcscasecmp_use_weak((a), (b))
#define std::wcsncasecmp(a, b, c) wcsncasecmp_use_weak((a), (b), (c))
...
*/
wchar_t *std::wcsdup(const wchar_t *in);
...
*/
int std::wcscasecmp(const wchar_t *a, const wchar_t *b);
...
/**
   ...
   a user-supplied string should be considered a bug.
*/
int std::wcsncasecmp(const wchar_t *a, const wchar_t *b, size_t count);
